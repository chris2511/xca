...
Please enter the DH parameter bits</source>
        <translation type="obsolete">Certaines applications ont besoin des paramètres de Diffie-Hellman. Ces derniers ne sont ni utilisés par XCA, ni enregistrés dans la base de données. Après les avoir générés, XCA demandera un nom de fichier dans lequel il les enregistrera.
